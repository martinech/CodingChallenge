namespace CodingChallenge.OldPhonePad.Tests
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            string test5 = "999337777#";                // YES
            string test6 = "8 88777444666*664#";        // TURING (O removed before N)
            string test7 = "4444#";                     // G
            string test8 = "1 2 3 4 5 6 7 8 9 0#";      // &ADGJMPTW_
        ...
        //The algorithm receives a string of numbers and has to return the corresponding text.
        //For this, it should check the first char, save it, and compare it with the next char,
        //if they are different then the corresponding letter is saved
